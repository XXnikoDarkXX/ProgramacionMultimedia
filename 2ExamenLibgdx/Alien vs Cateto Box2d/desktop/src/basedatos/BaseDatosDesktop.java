...
public class BaseDatosDesktop extends BaseDatos {
    private static final String cadenaConexion=
            "jdbc:mysql://127.0.0.1:3306/alienvscateto";
    ...
    public void cargarCuenta() {
        ...
        try {
            ...
            resultados.next();
            this.setAliensGenerados((short)resultados.getInt("numero"));
    ...
    public void persistir() {
        ...
        try {
            smt=conectar();
            smt.executeUpdate("update aliensGenerados set numero="+this.getAliensGenerados());
        } catch (SQLException throwables) {
            throwables.printStackTrace();
        }finally{
            try {
