...
public class Calipo extends Actor {
    ...
    public Calipo(Mundo w){

        this.mundo=w;
        //Asignamos la textura
        sprite=new Sprite(new Texture(Gdx.files.internal("actores/calipo.png")));
        ...
        FreeTypeFontGenerator generator = new FreeTypeFontGenerator(Gdx.files.internal("fuentes/impact.ttf"));
        FreeTypeFontGenerator.FreeTypeFontParameter parameter = new FreeTypeFontGenerator.FreeTypeFontParameter();
        parameter.size = 18;
        textoMuertes = generator.generateFont(parameter);
        contadorMuertes=0;
    }
